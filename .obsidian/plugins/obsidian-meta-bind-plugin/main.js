...
// src/inputFields/DatePicker/DatePickerInput.svelte
var import_obsidian10 = require("obsidian");

// src/utils/Icon.svelte
var import_obsidian9 = require("obsidian");
function add_css(target) {
  append_styles(target, "svelte-1elx65w", ".icon-wrapper.svelte-1elx65w{display:inline-block;position:relative;width:18px;height:18px}");
}
function create_if_block(ctx) {
  ...
  return {
    c() {
      div = element("div");
      attr(div, "class", "icon-wrapper svelte-1elx65w");
    },
    m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  let iconEl;
  onMount(() => {
    (0, import_obsidian9.setIcon)(iconEl, iconName);
  });
  ...
  return [iconName, iconEl, div_binding];
}
var Icon = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance, create_fragment, safe_not_equal, { iconName: 0 }, add_css);
  }
};
...
function add_css2(target) {
  append_styles(target, "svelte-1urcwq2", ".date-picker-input.svelte-1urcwq2{background:var(--background-secondary);border-radius:var(--meta-bind-plugin-border-radius);border:var(--meta-bind-plugin-border-width) solid var(--background-modifier-border);padding:5px 5px 5px 7px;cursor:pointer;position:relative;color:var(--text-normal);display:inline-flex;align-items:center;gap:5px}.date-picker-text.svelte-1urcwq2{display:inline-block}");
}
function create_fragment2(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "class", "date-picker-text svelte-1urcwq2");
      attr(div1, "class", "date-picker-input svelte-1urcwq2");
    },
    m(target, anchor) {
...
function instance2($$self, $$props, $$invalidate) {
  let { showDatePicker } = $$props;
  let { selectedDate = (0, import_obsidian10.moment)() } = $$props;
  let { dateFormat = "dddd, MMMM Do YYYY" } = $$props;
  function updateValue(value) {
    $$invalidate(0, selectedDate = value);
  }
  function datePicker(event) {
    showDatePicker();
  }
  function datePickerKey(event) {
    if (event.key === " ") {
      showDatePicker();
    }
  }
  $$self.$$set = ($$props2) => {
    if ("showDatePicker" in $$props2)
      $$invalidate(4, showDatePicker = $$props2.showDatePicker);
...
var DatePickerInput = class extends SvelteComponent {
  constructor(options) {
    super();
    init(
      this,
...
// src/inputFields/DatePicker/DatePickerModal.ts
...
function getDateRows(monthIndex, year) {
  const days = (0, import_obsidian11.moment)(new Date(year, monthIndex)).daysInMonth();
...
function add_css3(target) {
  append_styles(target, "svelte-1ouugmg", ".calendar.svelte-1ouugmg{margin-top:10px}.calendar-header.svelte-1ouugmg{display:flex;justify-content:space-around;flex-wrap:wrap;gap:var(--size-4-1);background:var(--background-secondary);border-radius:var(--meta-bind-plugin-border-radius);margin-bottom:var(--size-4-1);;}.calendar-content.svelte-1ouugmg{display:grid;flex-wrap:wrap;grid-template-columns:repeat(7, 1fr);gap:var(--size-4-1)}.cell.svelte-1ouugmg{min-width:40px;padding:var(--size-4-2);display:flex;justify-content:center;align-items:center;border-radius:var(--meta-bind-plugin-border-radius)}.content-cell.svelte-1ouugmg{cursor:pointer}.cell-text.svelte-1ouugmg{margin:auto;text-align:center}.selected.svelte-1ouugmg{background:var(--interactive-accent)}.highlight.svelte-1ouugmg:hover{background:var(--interactive-hover)}.selected.highlight.svelte-1ouugmg:hover{background:var(--interactive-accent-hover)}");
}
...
function create_each_block_1(ctx) {
  ...
  return {
    c() {
      ...
      t0 = text(t0_value);
      t1 = space();
      attr(span, "class", "cell-text svelte-1ouugmg");
      attr(div, "class", "cell header-cell svelte-1ouugmg");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      append(div, span);
...
function create_each_block(key_1, ctx) {
  ...
  return {
    ...
    c() {
      ...
      t1 = space();
      attr(span, "class", "cell-text svelte-1ouugmg");
      attr(div, "class", "cell svelte-1ouugmg");
      toggle_class(div, "highlight", ctx[10]);
      toggle_class(div, "content-cell", ctx[10]);
      toggle_class(div, "selected", ctx[0].year() === ctx[2] && ctx[0].month() === ctx[1] && ctx[0].date() === ctx[10]);
      this.first = div;
    },
    m(target, anchor) {
      insert(target, div, anchor);
    ...
    p(new_ctx, dirty) {
      ctx = new_ctx;
      if (dirty & 8 && t0_value !== (t0_value = (ctx[10] || "") + ""))
        set_data(t0, t0_value);
      if (dirty & 8) {
        toggle_class(div, "highlight", ctx[10]);
      }
...
function create_fragment3(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "class", "calendar-header svelte-1ouugmg");
      attr(div1, "class", "calendar-content svelte-1ouugmg");
      attr(div2, "class", "calendar svelte-1ouugmg");
    },
    m(target, anchor) {
...
function instance3($$self, $$props, $$invalidate) {
  ...
  function onChange(date) {
    dispatch("dateChange", (0, import_obsidian12.moment)(new Date(year, month, date)));
  }
  ...
  function selectCellKey(event, value) {
    if (event.key === " ") {
      selectCell(value);
    }
  }
  const click_handler = (value) => selectCell(value);
  const keydown_handler = (value, event) => selectCellKey(event, value);
  $$self.$$set = ($$props2) => {
    if ("selectedDate" in $$props2)
      $$invalidate(0, selectedDate = $$props2.selectedDate);
    if ("month" in $$props2)
...
var Calender = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance3, create_fragment3, safe_not_equal, { selectedDate: 0, month: 1, year: 2 }, add_css3);
  }
};
...
function add_css4(target) {
  append_styles(target, "svelte-1nlxj7b", ".date-picker.svelte-1nlxj7b{display:block;padding:var(--size-4-4)}.date-picker-header.svelte-1nlxj7b{display:flex;gap:var(--size-4-2);align-items:center;justify-content:space-around}.date-picker-header-text.svelte-1nlxj7b{flex:1;text-align:center;display:flex;gap:var(--size-4-2);align-items:center;justify-content:center;width:min-content}.date-picker-header-text-year.svelte-1nlxj7b{width:60px;padding:var(--size-4-2)}.date-picker-header-text-month.svelte-1nlxj7b{height:min-content}.month-switch-button.svelte-1nlxj7b{margin:0}");
}
function create_fragment4(ctx) {
  ...
  return {
    c() {
      ...
      attr(button0, "class", "month-switch-button svelte-1nlxj7b");
      attr(span, "class", "date-picker-header-text-month svelte-1nlxj7b");
      attr(input, "class", "date-picker-header-text-year svelte-1nlxj7b");
      attr(input, "type", "number");
      input.value = input_value_value = ctx[2].toString();
      attr(div0, "class", "date-picker-header-text svelte-1nlxj7b");
      attr(button1, "class", "month-switch-button svelte-1nlxj7b");
      attr(div1, "class", "date-picker-header svelte-1nlxj7b");
      attr(div2, "class", "date-picker svelte-1nlxj7b");
    },
    m(target, anchor) {
      insert(target, div2, anchor);
      append(div2, div1);
    ...
    p(ctx2, [dirty]) {
      ...
      if (!current || dirty & 4 && input_value_value !== (input_value_value = ctx2[2].toString()) && input.value !== input_value_value) {
...
function instance4($$self, $$props, $$invalidate) {
  const dispatch = createEventDispatcher();
  let { selectedDate = (0, import_obsidian13.moment)() } = $$props;
...
var DatePicker = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance4, create_fragment4, safe_not_equal, { selectedDate: 0, dateChangeCallback: 7 }, add_css4);
  }
};
var DatePicker_default = DatePicker;

// src/inputFields/DatePicker/DatePickerModal.ts
var DatePickerModal = class extends import_obsidian14.Modal {
  constructor(app, opener) {
    super(app);
    this.opener = opener;
  }
  onOpen() {
    const { contentEl } = this;
    new DatePicker_default({
      target: contentEl,
      props: {
        selectedDate: this.opener.date,
        dateChangeCallback: (value) => this.opener.datePickerValueChanged(value)
      }
    });
  }
};
...
var DatePickerInputField = class extends AbstractInputField {
  ...
  datePickerValueChanged(date) {
    var _a, _b;
    this.date = date;
    (_a = this.component) == null ? void 0 : _a.updateValue(this.date);
  ...
  render(container) {
    ...
    this.component = new DatePickerInput_default({
      target: container,
      props: {
...
var NumberInputField = class extends AbstractInputField {
  ...
  render(container) {
    ...
    const component = new import_obsidian15.TextComponent(container);
...
var LinkComponent = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance5, create_fragment5, safe_not_equal, { mdLink: 0 });
  }
};
...
function add_css5(target) {
  append_styles(target, "svelte-1r8vm9q", ".suggest-input.svelte-1r8vm9q{background:var(--background-secondary);border-radius:var(--meta-bind-plugin-border-radius);border:var(--meta-bind-plugin-border-width) solid var(--background-modifier-border);padding:5px 5px 5px 7px;cursor:pointer;position:relative;color:var(--text-normal);display:inline-flex;align-items:center;gap:5px}.suggest-text.svelte-1r8vm9q{display:inline-block}");
}
...
function create_fragment6(ctx) {
  ...
  return {
    c() {
      ...
      t = space();
      create_component(icon.$$.fragment);
      attr(div0, "class", "suggest-text svelte-1r8vm9q");
      attr(div1, "class", "suggest-input svelte-1r8vm9q");
    },
    m(target, anchor) {
      insert(target, div1, anchor);
      append(div1, div0);
...
function instance6($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("showSuggest" in $$props2)
      $$invalidate(5, showSuggest = $$props2.showSuggest);
  };
  return [
    mdLink,
    str,
...
var Suggest = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance6, create_fragment6, safe_not_equal, { showSuggest: 5, updateValue: 6 }, add_css5);
  }
  get updateValue() {
    return this.$$.ctx[6];
  }
...
var SuggestInputModal = class extends import_obsidian16.FuzzySuggestModal {
...
var SuggestInputField = class extends AbstractInputField {
  constructor(inputFieldMarkdownRenderChild, onValueChange) {
    ...
    if (this.needsDataview()) {
      if (!(0, import_obsidian_dataview.getAPI)(this.inputFieldMarkdownRenderChild.plugin.app)) {
  ...
  needsDataview() {
    return this.inputFieldMarkdownRenderChild.getArguments("suggestOptionQuery" /* SUGGEST_OPTION_QUERY */).length > 0;
  }
  async getOptions() {
    this.options = [];
    ...
    if (suggestOptionsQueryArguments.length > 0) {
      ...
      if (!dv) {
        new import_obsidian17.Notice("meta-bind | dataview needs to be installed and enabled to use suggest option queries");
        return;
      }
      for (const suggestOptionsQueryArgument of suggestOptionsQueryArguments) {
        const result = await dv.pages(suggestOptionsQueryArgument.value, this.inputFieldMarkdownRenderChild.filePath);
        result.forEach((file) => {
          try {
...
var InputFieldMarkdownRenderChild2 = class extends import_obsidian18.MarkdownRenderChild {
  ...
  parseBindTarget() {
    ...
    try {
      (0, import_Utils6.validatePath)(bindTargetMetadataFieldName);
    } catch (e) {
  ...
  async applyMetadataValueUpdateQueue() {
    if (!this.inputFieldDeclaration) {
    ...
    if (this.metadataValueUpdateQueue.length > 0) {
      await (0, import_API.updateOrInsertFieldInTFile)(this.bindTargetMetadataField, this.metadataValueUpdateQueue.at(-1), this.bindTargetFile, this.plugin);
    } else {
  ...
  async applyInputFieldValueUpdateQueue() {
    if (!this.inputFieldDeclaration) {
  ...
  getInitialValue() {
    ...
    if (((_a = this.inputFieldDeclaration) == null ? void 0 : _a.isBound) && this.bindTargetMetadataField) {
      const value = (0, import_Utils6.traverseObject)(this.bindTargetMetadataField, this.metaData);
...
var MetaBindPlugin = class extends import_obsidian19.Plugin {
  async onload() {
  ...
  updateMarkdownInputFieldsOnMetadataCacheChange(file, cache) {
    ...
    for (const activeMarkdownInputField of this.activeMarkdownInputFields) {
      ...
      if (activeMarkdownInputField.bindTargetFile.path === file.path) {
        activeMarkdownInputField.pushToInputFieldValueUpdateQueue((0, import_Utils8.traverseObject)(activeMarkdownInputField.bindTargetMetadataField, metadata));
      }
    }
  }
  getFilesByName(name) {
